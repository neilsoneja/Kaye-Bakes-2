    ...
    <main>
            ...
            <div class="container">
                            ...
                            foreach ($_SESSION['cart'] as $key => $value) {
                                $output .= "
                                    ...
                                    <tr>
                                        ...
                                        <td class='col-md-1'><input type='number' id='quantity' name='quantity' min='1' style='width: 40px;' value='".$value['quantity' ]."'></td>
                ...
                <div class="row justify-content-end py-5">
                    <div class="col-md-2">
                        <a href="/Kaye-Bakes-2/account/pre-order.php" class="btn ground-dark btn-secondary">Continue Shopping</a>  
                    </div>
                    <div class="col-md-3">
                        <form method="post"
                            ...
                            <button class="ground-dark btn btn-secondary" type="submit">Proceed to Checkout</button>  
